 ...
 *           type: string
 *           default: -createdAt
 *           enum: [-createdAt, price-asc, price-desc, rating, popularity]
 *         description: Sort field (Use price-asc/price-desc for price sorting)
 *       - in: query
 *         name: categoryId
 *         schema:
 *           type: integer
 ...
 *         schema:
 *           type: boolean
 *         description: Filter by new product status
 *       - in: query
 *         name: minPrice
 *         schema:
 *           type: number
 ...
 *         schema:
 *           type: string
 *         description: Search in name, description and short description
 *     responses:
 *       200:
